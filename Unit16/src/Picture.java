...
public class Picture extends SimplePicture 
{
  ...
  public void myCollage() {
	  Picture whiteFlower = new Picture("C:\\Users\\windy\\Downloads\\images-20210524T083648Z-001\\images\\whiteFlower.jpg");
	  this.copy(whiteFlower, 10, 10, 20, 200, 20, 300);
	  this.mirrorHorizontalBotToTop();
	  this.copy(whiteFlower, 0, 10, 20, 100, 50, 300);
	  this.mirrorHorizontal();
	  this.copy(whiteFlower, 10, 10, 30, 100, 20, 300);
	  this.grayscale();
  }
  ...
  public void edgeDetection2(int edgeDist)
  {
    ...
    for (int row = 0; row < pixels.length-1; row++)
    {
      for (int col = 0; col < pixels[0].length; col++)
      {
        ...
        color = botPixel.getColor();
        if (topPixel.colorDistance(color) > edgeDist)
  ...
  {
    Picture beach = new Picture("C:\\Users\\windy\\Downloads\\images-20210524T083648Z-001\\images\\blue-mark.jpg");
    beach.explore();
    beach.zeroBlue();
    beach.explore();
